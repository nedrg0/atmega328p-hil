...
#include <math.h>
#define LOOP_HZ 5000
#define TIMESTEP (double)((1.0 / LOOP_HZ)) 
...
#define MOTOR_USE_FIRST_ORDER_MODEL


#define MOTOR_MAX_RPM (6000U)
// DShot protocol MIN and MAX values
#define MOTOR_MIN_COMMAND 48
#define MOTOR_MAX_COMMAND 2047

// Define state size
#ifdef MOTOR_USE_FIRST_ORDER_MODEL
    #define MOTOR_STATE_SIZE 1
#else 
    #define MOTOR_STATE_SIZE 2
#endif

#define STATE_SIZE (13 + 4 * MOTOR_STATE_SIZE)
typedef struct 
{
    float x[STATE_SIZE];
}State_raw_t;
